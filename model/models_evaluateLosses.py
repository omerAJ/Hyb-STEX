...
class STSSL(nn.Module):
    ...
    def forward(self, view1, graph):
        ...
        repr1A, nodes_statusA = self.encoderA(view1A, learnable_graph) # view1: n,l,v,c; graph: v,v 
        repr1B, nodes_statusB = self.encoderB(view1B, learnable_graph) # view1: n,l,v,c; graph: v,v 
        ...
        combined_nodes_status = torch.mean(torch.stack([nodes_statusA, nodes_statusB]), dim=0)
